...
function padString(original, length, padWith, side) {
  switch (side) {
  case  "start": return original.padStart(length, padWith, );
  case "end": return original.padEnd(length, padWith, );
  default: return "Error: side should be either 'start' or 'end'";
  }
}
...
//       original = padWith + original;
//     }
//   } else if (side === "end") {
//     while (original.length < length) {
//       original = original + padWith;
//     }
//   } else {
//     return "Error: side повинен бути 'start' або 'end'";
//   }
//   return original;
// }
...
function trimString(original, side) {
  switch (side) {
    case  "start": return original.trimStart();   
    case "end": return original.trimEnd();    
    case "both": return original.trim();
    default: return "Error: side should be either 'start', 'end' or 'both'";
    }
...
function convertCase(original, caseType) {
  switch (caseType) {
    case "upper": return original.toUpperCase();   
    case "lower": return original.toLowerCase();
    default: return "Error: caseType should be either 'upper' or 'lower'";
  }
